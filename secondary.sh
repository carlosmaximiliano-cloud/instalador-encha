...
ferramenta_traefik_e_portainer() {
  ...
  while true; do
    ...
    echo -e "\e[32mURL formatada: $url_portainer\e[0m\n"
    ...
    while true; do
        ...
        echo -e "\e[33m--> Mínimo 12 caracteres...\e[0m"
        echo -ne "\e[36mDigite uma senha para o Portainer: \e[0m" && read -r pass_portainer
        echo ""
    ...
    echo -ne "\e[36mEscolha um nome para o seu servidor: \e[0m" && read -r nome_servidor
    echo ""
    echo -e "Passo \e[33m5/6\e[0m 🌐"
    echo -ne "\e[36mDigite um nome para sua rede interna: \e[0m" && read -r nome_rede_interna
    echo ""
    echo -e "Passo \e[33m6/6\e[0m 📧"
    echo -ne "\e[36mDigite um endereço de email válido: \e[0m" && read -r email_ssl
    echo ""

    clear
    msg_traefik_portainer
    echo -e "\e[33m🔍 Revisão:\e[0m"
    echo -e "Domínio: $url_portainer | Usuário: $user_portainer | Rede: $nome_rede_interna"
    read -p $'\e[32m✅ Confirmar? (Y/N): \e[0m' confirmacao
...
EOL
  ...
  echo -e "⚙️ \e[97mConfigurando Sistema e Docker... \e[33m[3/9]\e[0m"
...
EOL
  ...
  echo -e "\e[36m⏳ Aguardando propagação do DNS/SSL (20s)...\e[0m"
  sleep 20
  ...
  for i in $(seq 1 $MAX_RETRIES); do
      ...
      if [ "$HTTP_CODE" -eq 200 ] || [ "$HTTP_CODE" -eq 409 ]; then 
          ...
          if echo "$RESPONSE" | grep -q "Username" || [ "$HTTP_CODE" -eq 409 ]; then
              CONTA_CRIADA=true
              echo "✅ Conta criada ou já existente."
              break
          fi
      fi
      sleep 15
